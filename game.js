...
GameState.prototype.create = function() {
    ...
    this.gun = this.game.add.sprite(50, this.game.height - 64, 'canon');
    ...
    this.debugText = this.game.add.text(
...
GameState.prototype.drawTrajectory = function() {
    ...
    this.bitmap.context.fillStyle = 'rgba(215, 81, 68, 0.7)';
...
GameState.prototype.handleInput = function(){
   //KB->UP
    ...
    if(game.input.keyboard.isDown(Phaser.Keyboard.LEFT)){
      this.BULLET_SPEED = this.BULLET_SPEED-10;
    }
    //KB->RIGHT
